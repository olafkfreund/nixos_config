...
g3:
    nixos-rebuild switch --flake .#g3 --target-host g3 --build-host hp --use-remote-sudo --show-trace

hp:
    nixos-rebuild switch --flake .#hp --target-host hp --build-host hp --use-remote-sudo --show-trace

lms:
    nixos-rebuild switch --flake .#lms --target-host lms --build-host hp --use-remote-sudo --show-trace
