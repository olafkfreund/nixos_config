...
A comprehensive, optional GNOME desktop environment configuration for NixOS with Gruvbox theming, extensions support, and extensive customization options.
