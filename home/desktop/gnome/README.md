...
A comprehensive, optional GNOME desktop environment configuration for NixOS with base16 theming,
extensions support, and extensive customization options.

## Features

- **🎨 Base16 Theming**: GTK, icon and cursor themes generated by Stylix from the active scheme
...
```nix
desktop.gnome.theme = {
  enable = true;           # Enable base16 theming
...
- **GTK Theme**: adw-gtk3 + the Stylix-generated base16 `gtk.css`
- **Icon Theme**: Papirus-Dark (green folders)
- **Cursor Theme**: Bibata-Modern-Classic
- **Fonts**: Inter (UI), JetBrainsMono Nerd Font (terminal)

### Terminal Colors

Base16 color palette for GNOME Terminal with proper contrast and readability.

### Custom CSS

Additional styling for a consistent appearance across all GNOME applications.
...
├── theme.nix        # Stylix integration and dconf theming
