...
static const char *const autostart[] = {
  ...
  "sh", "-c", "feh --randomize --bg-fill ~/Pictures/wallpapers/gruvbox/hypr/*", NULL,
  "slstatus", NULL,
  NULL /* terminate */
};
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_e,          spawn,                  SHCMD ("nautilus")}, // open thunar file manager
	...
	{ MODKEY|ControlMask,           XK_q,          spawn,                  SHCMD("$HOME/.config/rofi/powermenu/type-2/powermenu.sh")}, // exit dwm
